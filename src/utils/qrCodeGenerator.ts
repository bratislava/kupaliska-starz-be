...
export const generateQrCodeBuffer = (data: string, options?: QRCodeToBufferOptions) =>
	QRCode.toBuffer(data, {
		errorCorrectionLevel: 'H',
		...(options ?? {}),
	})

export const generateQrCodeDataUrl = (data: string, options?: QRCodeToDataURLOptions) =>
