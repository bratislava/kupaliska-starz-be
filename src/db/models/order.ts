...
export class OrderModel extends DatabaseModel {
	...
	getItems() {
		...
		const adults = reduce<TicketModel[], OrderItem>(self.tickets, (obj: OrderItem, ticket: TicketModel) => {
		...
		const children = reduce<TicketModel[], OrderItem>(self.tickets, (obj: OrderItem, ticket: TicketModel) => {
