import { CHECK_STATUS, ENTRY_FLAG, ENTRY_TYPE, TICKET_CHECKIN_ERROR_CODE } from './../../../../../src/utils/enums';
import supertest from 'supertest'
import Joi from 'joi'
import app from '../../../../../src/app'
import { TicketModel } from '../../../../../src/db/models/ticket';

const endpoint = (swimmingPoolId = 'c70954c7-970d-4f1a-acf4-12b91acabe01') => `/api/admin/tickets/swimmingPools/${swimmingPoolId}/checkin`
...
describe(`[POST] ${endpoint})`, () => {
	...
	it('Check-in NOT OK', async () => {
		...
		const response = await request.post(endpoint(disallowedSwimmingPool))
			.set('Content-Type', 'application/json')
			.set('Authorization', `Bearer ${process.env.jwtOperator}`)
